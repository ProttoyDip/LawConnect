...
// Search filters (public for filter options, authorized for search)
Route::get('/search/filter-options', [SearchController::class, 'filterOptions']); Route::post('/forgot-password', [PasswordResetLinkController::class, 'store']);
...
Route::middleware(['auth:sanctum', 'log.api'])->group(function () {
    ...
    Route::get('/search/crime-reports', [SearchController::class, 'crimereports']);

    // Export
    Route::prefix('export')->group(function () {
        Route::get('/reports/csv', [ExportController::class, 'reportsCsv']);
        Route::get('/reports/pdf-data', [ExportController::class, 'reportsPdfData']);
    });

    // Activity Logs
    Route::prefix('activity')->group(function () {
        Route::get('/case/{id}', [ActivityController::class, 'caseActivity']);
        Route::get('/my-activity', [ActivityController::class, 'myActivity']);
        Route::get('/admin', [ActivityController::class, 'logs'])->middleware('role:admin');
    });
